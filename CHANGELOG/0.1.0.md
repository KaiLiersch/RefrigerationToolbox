...
- `src/refrigerationtoolbox/` package with CLI (Typer + Rich), py.typed marker
...
[@KaiLiersch](https://github.com/KaiLiersch) (Kai Liersch) created RefrigerationToolbox.
